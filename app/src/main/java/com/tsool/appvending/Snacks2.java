...
public class Snacks2 extends AppCompatActivity {
    ...
    TextView txvProduct1,txvProduct2,txvProduct3,txvProduct4,txvProduct5,txvProduct6,txvProduct7,txvProduct8,txvProduct9,txvProduct10,
            ...
            txvProduct31,txvProduct32;

    EditText etxAjustesSnacks2,etxLecturaSnacks2;
    MenuItem miSave;
    ...
    private static boolean productRegistered1,productRegistered2,productRegistered3,productRegistered4,productRegistered5,productRegistered6,productRegistered7,productRegistered8,productRegistered9,productRegistered10,
            ...
            productRegistered31,productRegistered32;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txvProduct1 = (TextView) findViewById(R.id.txvSnacks2Product1);
        txvProduct2 = (TextView) findViewById(R.id.txvSnacks2Product2);
        txvProduct3 = (TextView) findViewById(R.id.txvSnacks2Product3);
        txvProduct4 = (TextView) findViewById(R.id.txvSnacks2Product4);
        txvProduct5 = (TextView) findViewById(R.id.txvSnacks2Product5);
        txvProduct6 = (TextView) findViewById(R.id.txvSnacks2Product6);
        txvProduct7 = (TextView) findViewById(R.id.txvSnacks2Product7);
        txvProduct8 = (TextView) findViewById(R.id.txvSnacks2Product8);
        txvProduct9 = (TextView) findViewById(R.id.txvSnacks2Product9);
        txvProduct10 = (TextView) findViewById(R.id.txvSnacks2Product10);
        txvProduct11 = (TextView) findViewById(R.id.txvSnacks2Product11);
        txvProduct12 = (TextView) findViewById(R.id.txvSnacks2Product12);
        txvProduct13 = (TextView) findViewById(R.id.txvSnacks2Product13);
        txvProduct14 = (TextView) findViewById(R.id.txvSnacks2Product14);
        txvProduct15 = (TextView) findViewById(R.id.txvSnacks2Product15);
        txvProduct16 = (TextView) findViewById(R.id.txvSnacks2Product16);
        txvProduct17 = (TextView) findViewById(R.id.txvSnacks2Product17);
        txvProduct18 = (TextView) findViewById(R.id.txvSnacks2Product18);
        txvProduct19 = (TextView) findViewById(R.id.txvSnacks2Product19);
        txvProduct20 = (TextView) findViewById(R.id.txvSnacks2Product20);
        txvProduct21 = (TextView) findViewById(R.id.txvSnacks2Product21);
        txvProduct22 = (TextView) findViewById(R.id.txvSnacks2Product22);
        txvProduct23 = (TextView) findViewById(R.id.txvSnacks2Product23);
        txvProduct24 = (TextView) findViewById(R.id.txvSnacks2Product24);
        txvProduct25 = (TextView) findViewById(R.id.txvSnacks2Product25);
        txvProduct26 = (TextView) findViewById(R.id.txvSnacks2Product26);
        txvProduct27 = (TextView) findViewById(R.id.txvSnacks2Product27);
        txvProduct28 = (TextView) findViewById(R.id.txvSnacks2Product28);
        txvProduct29 = (TextView) findViewById(R.id.txvSnacks2Product29);
        txvProduct30 = (TextView) findViewById(R.id.txvSnacks2Product30);
        txvProduct31 = (TextView) findViewById(R.id.txvSnacks2Product31);
        txvProduct32 = (TextView) findViewById(R.id.txvSnacks2Product32);

        etxLecturaSnacks2 = (EditText)findViewById(R.id.etxLecturaSnacks2);
        etxAjustesSnacks2 = (EditText)findViewById(R.id.etxAjustesSnacks2);

        etxAjustesSnacks2.setText("0");
        ...
        if(productRegistered == true){
            switch (posicionSeleccionada){
                ...
                case 30:
                    ...
                    break;
                case 31:
                    productRegistered31 = true;
                    break;
                case 32:
                    productRegistered32 = true;
                    break;
                default:
                    break;
            }
            ...
            if(!(lectura == 0)) {
                etxLecturaSnacks2.setText(String.valueOf(lectura));
            }
            if(!(ajustes == 0)){
                etxAjustesSnacks2.setText(String.valueOf(ajustes));
            }
        ...
        txvProduct1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Snacks2.this, AddProduct.class));
        ...
        txvProduct31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Snacks2.this,AddProduct.class));
                posicionSeleccionada = 31;
                GetIndex();
            }
        });
        txvProduct32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Snacks2.this,AddProduct.class));
                posicionSeleccionada = 32;
                GetIndex();
            }
        });
    }
    ...
    private void GetIndex(){
        indexObtained = false;
        if(!etxLecturaSnacks2.getText().toString().equals("")) {
            lectura = Float.valueOf(etxLecturaSnacks2.getText().toString());
        }else{
            lectura = 0;
        }
        if(!etxAjustesSnacks2.getText().toString().equals("")) {
            ajustes = Float.valueOf(etxAjustesSnacks2.getText().toString());
        }else{
            ajustes = 0;
        }
    ...
    private void CleanVariables(){
        ...
        productRegistered31 = false;
        productRegistered32 = false;
        lectura = 0;
        ajustes = 0;
    }
        ...
        for (Product product : mProductList) {
            switch (product.Posicion) {
                ...
                case 30:
                    ...
                    break;
                case 31:
                    txvProduct31.setText(product.Name + "\n" + "$" + String.valueOf(product.Price));
                    break;
                case 32:
                    txvProduct32.setText(product.Name + "\n" + "$" + String.valueOf(product.Price));
                    break;
                default:
                    break;
            }
            ...
            protected Void doInBackground(Void... params) {
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            MobileService objMobileService = new MobileService(Snacks2.this);
                            ...
                            startActivity(new Intent(Snacks2.this, MainActivity.class));
                            CleanVariables();
                        }
                    });
                }catch (Exception ex){}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.actionSave:
                ...
                if (etxLecturaSnacks2.getText().toString().equals("")||etxAjustesSnacks2.getText().toString().equals("")) {
                    if (etxLecturaSnacks2.getText().toString().equals("")) {
                        etxLecturaSnacks2.setError("Ingresar el total de la lectura");
                    }
                    if (etxAjustesSnacks2.getText().toString().equals("")) {
                        etxAjustesSnacks2.setError("Ingresar el total de los ajustes");
                    }
                }else {
                        ...
                        lectura.Valor = Float.valueOf(etxLecturaSnacks2.getText().toString());
                        lectura.Reposiciones = Float.valueOf(etxAjustesSnacks2.getText().toString());
    ...
    private void changeSelectedProducts(){
        ...
        if(productRegistered31==true){
            txvProduct31.setTextColor(txvProduct31.getContext().getResources().getColor(R.color.forest));
            txvProduct31.setBackground(txvProduct31.getContext().getResources().getDrawable(R.drawable.background_listview_maquinas));
        }
        if(productRegistered32==true){
            txvProduct32.setTextColor(txvProduct32.getContext().getResources().getColor(R.color.forest));
            txvProduct32.setBackground(txvProduct32.getContext().getResources().getDrawable(R.drawable.background_listview_maquinas));
        }
    }
